...
description: WTW is a mobile app to share local events based off the geolocation of a user.
date: "2021-05-01"
url: https://github.com/giguerejatwit/ReactNativeApp.git
repository: giguerejateit
published: true
---
